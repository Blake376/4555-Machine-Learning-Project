...
// 0 if score <88
// 1 if score is between 88 and 94 (including 88 and 94)
// 2 if score >94
public class Wine_3Classes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String filenameTest  = new ClassPathResource("4555_Project/wine_5/winemag-data-SET_5-TEST.csv").getFile().getPath();
        ...
        rr.initialize(new FileSplit(new ClassPathResource("4555_Project/wine_5/winemag-data-SET_5-TRAIN.csv").getFile()));
        rr.reset();
        ...
        rrTest.initialize(new FileSplit(new ClassPathResource("4555_Project/wine_5/winemag-data-SET_5-TEST.csv").getFile()));
        rrTest.reset();
